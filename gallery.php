...
// for photo
$query_photo = "SELECT * FROM `photo` ORDER BY `created` Desc";
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb mb-2">
          ...
          <li class="list-inline-item text-white h3 font-secondary nasted">Gallery</li>
        </ul>
    ...
    ?>
      ...
      <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0" style="margin-bottom: 15px !important;">
        <div class="card rounded-0 hover-shadow border-top-0 border-left-0 border-right-0">
          <img class="card-img-top rounded-0" src="<?php echo ADMIN_URL.'/'.$data_photo['photo_link'];?>" alt="scholarship-thumb" style="width: 350px; height: 262px;">
        </div>
      </div>
    <?php }
      }?>
