                ...
                <div class="col-auto">
                    <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            <div class="col-auto">
                                <a class="btn app-btn-secondary" href="<?php echo BASE_URL.'event';?>">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td width="10%"><img src="<?php echo $data['event_picture'];?>" style="height: 70px;" /></td>
                                                ...
                                                <td width="10%"><?php echo date('H:i:s',strtotime($data['time']));?></td>
                                                <td width="10%"><?php echo $data['location'];?></td>
                                                ...
                                                <?php }?>
                                                <td width="10%">
                                                    <a href="<?php echo BASE_URL.'event?type=edit&uid='.$data['id'];?>"><svg width="1.5em" height="1.5em" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M21,12a1,1,0,0,0-1,1v6a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V5A1,1,0,0,1,5,4h6a1,1,0,0,0,0-2H5A3,3,0,0,0,2,5V19a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V13A1,1,0,0,0,21,12ZM6,12.76V17a1,1,0,0,0,1,1h4.24a1,1,0,0,0,.71-.29l6.92-6.93h0L21.71,8a1,1,0,0,0,0-1.42L17.47,2.29a1,1,0,0,0-1.42,0L13.23,5.12h0L6.29,12.05A1,1,0,0,0,6,12.76ZM16.76,4.41l2.83,2.83L18.17,8.66,15.34,5.83ZM8,13.17l5.93-5.93,2.83,2.83L10.83,16H8Z"/>
                                                    </svg></a>
                                                    
                                                    <a href="<?php echo BASE_URL.'event?type=delete&uid='.$data['id'];?>">
